...
void main() {
  ...
  testWidgets('dashboard calculation, balance display, and refresh integration test', (tester) async {
    await app.main();
    ...
    await tester.scrollUntilVisible(find.text('Safe-to-Spend Balance'), -200.0);
    expect(find.text('Safe-to-Spend Balance'), findsOneWidget);
