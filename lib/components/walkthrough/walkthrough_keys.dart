...
class WalkthroughKeys {
  static final GlobalKey balanceCardKey = GlobalKey(debugLabel: 'walkthrough_balance_card');
  static final GlobalKey privacyToggleKey = GlobalKey(debugLabel: 'walkthrough_privacy_toggle');
  static final GlobalKey voiceFabKey = GlobalKey(debugLabel: 'walkthrough_voice_fab');
  static final GlobalKey goalsSummaryKey = GlobalKey(debugLabel: 'walkthrough_goals_summary');
  static final GlobalKey accountsSummaryKey = GlobalKey(debugLabel: 'walkthrough_accounts_summary');
