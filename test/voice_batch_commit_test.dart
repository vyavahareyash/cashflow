...
void main() {
  ...
  setUp(() async {
    ...
    tempDir = await Directory.systemTemp.createTemp('cashflow_voice_batch_test_');
  ...
  group('Atomic Batch Commit and Reactive State Synchronization (Issue #88, #78)', () {
    ...
    testWidgets('4. Staging sheet UI: 3 valid transactions -> tap "Approve All" (US 11)', (tester) async {
      final db = DatabaseHelper.instance;
      int bankId = 0;
      int catId = 0;
      ...
      final testAccs = [
        Account(id: bankId, name: 'Primary Checking', balance: 1500.0, type: 'Bank'),
      ];
      final testCats = [
        Category(id: catId, name: 'Groceries', monthlyBudget: 600.0, type: 'expense'),
      ];
    ...
    testWidgets('5. Staging sheet UI: 2 valid + 1 draft with missing account -> tap "Approve Valid" then fix and commit (US 12)', (tester) async {
      final db = DatabaseHelper.instance;
      int bankId = 0;
      int catId = 0;
      await tester.runAsync(() async {
      ...
      final testCats = [
        Category(id: catId, name: 'Fast Food', monthlyBudget: 200.0, type: 'expense'),
      ];
    ...
    testWidgets('6. Reactive state synchronization: Dashboard updates immediately upon commitDraftTransactions', (tester) async {
