...
void main() {
  group('CreditCardAccountCard Widget Tests', () {
    ...
    testWidgets(
      'renders card name, billing days, limit, outstanding, and utilization',
      (tester) async {
    ...
    testWidgets('displays 100% Backed badge when lockedAmount >= outstanding', (
      tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets(
      'displays Partial cash-backed badge when 0 < lockedAmount < outstanding',
      (tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
    ...
    testWidgets(
      'displays Unbacked badge when lockedAmount == 0 and outstanding > 0',
      (tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
    ...
    testWidgets('triggers onPayBill callback when Pay Bill button is tapped', (
      tester,
    ) async {
  ...
  group('PayCcBillModal Widget Tests', () {
    ...
    testWidgets('renders modal header, current due, and payment options', (
      tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets(
      'switching to custom amount displays amount input and confirms button',
      (tester) async {
