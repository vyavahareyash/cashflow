...
void main() {
  ...
  test('seeded demo data exercises complete multi-month timeline and scenarios', () async {
    ...
    final monthlySpending = await db.getMonthlySpendingByCategoryId(cycle: cycle);
    ...
    expect(
      categories.any((c) => c.monthlyBudget == null),
      isTrue,
    );
